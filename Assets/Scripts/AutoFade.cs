...
/*
 * Ci-dessous la ligne de code à utiliser pour appeler ce script
 * 
 * AutoFade.LoadLevel (idScene,0.5f,0.5f,Color.black);
 * 
 * de gauche à droite : id de la scène, temps de FadeIn, Temps de FadeOut, Couleur du fade
 * 
 * */
